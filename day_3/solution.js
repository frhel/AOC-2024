...
const _DAY = '03'; // Auto-generated by create.sh script. See README.md for details: https://github.com/frhel/AOC-2024/blob/main/README.md
...
let _ANSWERS = {'part_1': '***','part_2': '***'}; // Object to keep track of individual answers
...
function solvePart1(data) {
	...
	let answer = data.reduce((acc, item) => {
		// If the item is not 'do()' or 'don't()', return the accumulator plus the multiplication of the two numbers
...
function solvePart2(data) {
	...
	let answer = data.reduce((acc, item) => {
		...
		// Return the accumulator plus the multiplication of the two numbers if can_multi is true and the item is not a string
		// In the case of 'do()' or 'don't()', return the accumulator as is and move on to the next item
